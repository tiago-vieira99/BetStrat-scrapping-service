...
def scrappAdAStatsBulk(monthh, day):
    ...
    #         try:
    #             matches += getAdaMatchesByDay("https://www.academiadasapostas.com/stats/livescores/2024/"+ str(month) + "/" + str(i), driver)
    #             with open("scrapper/newData/matchesLinksByAda_2024_" + str(month) + ".json", 'a', encoding='utf-8') as file:
