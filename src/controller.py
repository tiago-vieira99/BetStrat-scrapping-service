...
def filter_criteria_over25_match(match):
    ...
    filtered_comps = ["Argentina - Primera División", "Arménia - Premier League", "Ásia - AFC Champions League", "Austrália - A-League", "Catar - QSL Cup", "Cazaquistão - Premier League", "Chile - Copa Chile", "Escócia - FA Cup", "Eslováquia - 2. liga", "Eslováquia - Cup", "Estónia - Cup", "Europa - UEFA Champions League", "França - Coupe de France", "Húngria - Magyar Kupa", "Índia - I-League", "Inglaterra - FA Cup", "Inglaterra - Premier League", "Islândia - 1. Deild", "Islândia - Cup", "Islândia - Úrvalsdeild", "Israel - State Cup", "Israel - Toto Cup Ligat Al", "Itália - Coppa Italia", "Japão - Emperor Cup", "Lituânia - A Lyga", "Malásia - Super League", "Noruega - NM Cupen", "Países Baixos - Eerste Divisie", "Perú - Segunda División", "Polónia - Cup", "Portugal - Taça da Liga", "Portugal - Taça de Portugal", "República da Irlanda - FAI Cup", "RP China - CSL", "Rússia - Cup", "Rússia - FNL", "Suíça - Challenge League", "Suíça - Schweizer Pokal", "Turquia - Cup"]
